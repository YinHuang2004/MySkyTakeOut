...
//prefix表示配置文件中的属性前缀，这里是campus_delivery.jwt，表示将配置文件（application-dev.yml）中的属性值注入到当前类的属性中时，需要将属性名前缀为campus_delivery.jwt的属性值注入到当前类的属性中
//例如：campus_delivery.jwt.adminSecretKey = 123456，将123456注入到adminSecretKey属性中
...
@ConfigurationProperties(prefix = "campus_delivery.jwt")
@Data
